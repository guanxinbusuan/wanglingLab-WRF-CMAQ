...
#> 模拟通用设置
 ...
 set APPL      = d02_202409        #> Application Name (e.g. Gridname)
...
setenv GRID_NAME d02_202409             #> 查看 GRIDDESC 文件中的 GRID_NAME 选项
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     ...
     setenv ICFILE ICON_v532_d02_202409_regrid_202409
  ...
  set BCFILE = BCON_v532_d02_202409_regrid_202409        #> 边界条件 其实就是 BCON输出的 BC 场文件
  ...
  set EMISfile  = emis_meic_cb6r3_ae7_aq_20240905_d02_daily.nc
  ...
  if ( $CTM_BIOGEMIS == 'Y' ) then   
     ...
     setenv B3GRD      $IN_BEISpath/B3GRD_d02.nc
