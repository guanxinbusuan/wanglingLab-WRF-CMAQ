...
#> 水平网格定义 
 setenv GRID_NAME d02_202409               #> 查看 GRIDDESC 文件的GRID_NAME 选项，其实就是嵌套域名称
...
#     CTM_CONC_1 = 粗网格CCTM的浓度文件(d01的CCTM输出，CONC文件，不是ACONC文件)        
#     MET_CRO_3D_CRS = 粗网格 MET_CRO_3D 气象文件(d01的MCIP输出)
...
# =====================================================================
 ...
 if ( $BCON_TYPE == regrid ) then 
    setenv CTM_CONC_1 $CMAQ_DATA/cctm/output_CCTM_v532_intel_d01_202409/CCTM_CONC_v532_intel_d01_202409_${YYYYMMDD}.nc
    setenv MET_CRO_3D_CRS $CMAQ_DATA/mcip/d01_202409/METCRO3D_${YYYYMM}.nc
